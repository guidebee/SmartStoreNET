...
namespace SmartStore.WebApi
{
    public class SwaggerConfig
    {
        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "Markit.Api");
        ...
        /// <summary>
        /// Class AddAuthorizationHeaderFilter.
        /// </summary>
        /// <seealso cref="Swashbuckle.Swagger.IOperationFilter" />
        /// <remarks>Mine's Yours</remarks>
        private class AddAuthorizationHeaderFilter : IOperationFilter
        {
            /// <summary>
            ...
            public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
            {
                ...
                if (apiDescription.ActionDescriptor.GetFilterPipeline()
